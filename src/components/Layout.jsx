...
export default function Layout({ children }) {
    ...
    return (
        <div className="flex h-screen overflow-hidden w-full bg-background relative">
            ...
            <div className="flex-1 flex flex-col md:ml-[260px] h-screen overflow-hidden relative w-full">
                <Header title={"Fooddy Shop"} onMenuToggle={() => setIsSidebarOpen(!isSidebarOpen)} />
