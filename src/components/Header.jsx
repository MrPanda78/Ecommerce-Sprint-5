...
export function Header({ onMenuToggle, title }) {
    return (
        ...
        <div className="flex items-center gap-2 flex-1">
            ...
            className="md:hidden text-on-surface hover:text-primary transition-colors p-1 cursor-pointer"
            >
            ...
            <span className="md:hidden font-headline-sm text-lg font-bold text-primary w-48">
            {title}
            </span>
        </div>
        ...
        <div className="flex items-center gap-1 shrink-0">
            ...
            <div className="text-right hidden sm:block">
                ...
                <p className="text-[10px] uppercase font-bold tracking-wider text-on-surface-variant leading-tight mt-0.5">
                Manager
                </p>
            </div>
