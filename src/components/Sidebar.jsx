...
export function Sidebar({ currentView, onNavigate, isOpen, onClose })
{
    ...
    return (
        ...
        <aside 
            className={`fixed left-0 top-0 h-full w-[260px] bg-surface-container-low border-r border-white/10 flex flex-col z-40 transition-transform duration-300 md:translate-x-0 ${
        ...
        >
            ...
            <div>
                ...
                <p className="text-on-surface-variant text-label-caps font-semibold uppercase tracking-wider text-[10px] mt-0.5">
                Admin Dashboard
                </p>
            </div>
            </div>
            ...
            <button
                ...
                className={`flex cursor-pointer items-center gap-3 px-4 py-2 rounded-lg font-bold transition-all active:scale-[0.98] duration-150 w-full text-left
                ${
            ...
            <div className="flex flex-col">
                ...
                className={`flex cursor-pointer items-center justify-between px-4 py-3 rounded-lg transition-all active:scale-[0.98] duration-150 w-full text-left
                    ${
                ...
                <div
                className={`${
                    productosExpanded ? 'flex' : 'hidden'
                } flex-col pl-[44px] pr-4 py-2 gap-2 border-l border-white/10 ml-6 mt-1`}
                >
                <a
                    className="text-primary font-medium transition-colors py-1 text-sm cursor-pointer"
                    onClick={() => {
                    onNavigate('products');
                    onClose();
                    }}
            ...
            <div className="flex flex-col">
                ...
                onClick={() => {
                    ...
                    setCategoriasExpanded(!categoriasExpanded);
                    }
                }}
                className={`flex cursor-pointer items-center justify-between px-4 py-3 rounded-lg transition-all active:scale-[0.98] duration-150 w-full text-left
                    ${
